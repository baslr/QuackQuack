...
// MARK: - Schema V9 (Session Goal)

/// V9 adds `goal` to `ChatSession`, set via the `/goal` composer command
/// and injected into the system prompt.
public enum QuackSchemaV9: VersionedSchema {
    public nonisolated(unsafe) static var versionIdentifier: Schema.Version = .init(9, 0, 0)
...
public enum QuackMigrationPlan: SchemaMigrationPlan {
    public static var schemas: [any VersionedSchema.Type] {
        [QuackSchemaV1.self, QuackSchemaV2.self, QuackSchemaV3.self, QuackSchemaV4.self, QuackSchemaV5.self, QuackSchemaV6.self, QuackSchemaV7.self, QuackSchemaV8.self, QuackSchemaV9.self]
    }
    ...
    public static var stages: [MigrationStage] {
        [
            ...
            // V8 → V9: adds goal to ChatSession.
            .lightweight(fromVersion: QuackSchemaV8.self, toVersion: QuackSchemaV9.self),
        ]
    }
}
